...
export const AppBase=()=>{
    ...
    const getEvents=()=>{
        setDataLoading(true);
        axios.get("https://event-assignment-backend.vercel.app/api/event/events").then((res)=>{
    ...
    const bookTicket=(id)=>{
        setDataLoading(true);
        axios.post(`https://event-assignment-backend.vercel.app/api/ticket/book/${id}`).then((res)=>{
